                        ...
                        <?php foreach ($kategori_berita as $k): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('index.php/kategori/hapus/'. $k['idkategori']);?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus berita ini?')">Hapus</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                    </tbody>
